...
public class NearbyStadiumActivity extends FragmentActivity {

    EditText editTextStadium;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextStadium = findViewById(R.id.stadiums_spinner);
        ...
        System.out.println("GRAMENT UP ? :" + supportMapFragment);
        editTextStadium.setText("Stadium");
        editTextStadium.setEnabled(false);

        fusedLocationClient = LocationServices.getFusedLocationProviderClient(this);
        //System.out.println("FUSED IS NULL" + fusedLocationProviderClient);
        ...
        if(ActivityCompat.checkSelfPermission(NearbyStadiumActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
            System.out.println("GRANTED" + googleMap);
            getCurrentLocation();
        } else {
